...
export const api = {
  ...
  // Point d'entrée unique du chatbot "SeconBot" : gère recherche produit, aide à la vente,
  // navigation, sécurité, livraison, compte — gratuit par défaut (voir backend/src/routes/ai.js)
  chat: (message) => fetch(`${API_URL}/ai/chat`, {
